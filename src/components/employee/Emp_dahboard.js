  ...
  return (
    <div>
      ...
      <div className='sidebar1'>
        <h4 id="menu">MENU</h4>
        <button className='button1' onClick={() => { navigate("/empview") }}>MY DETAILS</button>
        <button className='button2' onClick={() => { navigate("/empedit") }}>EDIT DETAILS</button>
        <button className='button3' onClick={() => { navigate("/leavelist") }} >LEAVE STATUS</button>
        <button className='button4' onClick={() => { navigate("/leaveform") }}>APPLY LEAVE</button>
      </div>
    </div>
  )
}
